...
val OledThemeColors =
    object : ThemeColors {
        ...
        val onPrimaryDark = Color(0xC0FFFFFF)
        ...
        val onSecondaryContainerDark = onPrimaryDark
        val tertiaryDark = Color(0xFF909090)
        val onTertiaryDark = onPrimaryDark
