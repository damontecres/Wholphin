...
fun SeasonCard(
    ...
    val spaceBetween by animateDpAsState(if (focused) 12.dp else 4.dp, label = "spaceBetween")
    val spaceBelow by animateDpAsState(if (focused) 4.dp else 12.dp, label = "spaceBelow")
        ...
        Column(
            ...
            modifier =
                Modifier
                    ...
                    .offset {
                        IntOffset(0, (spaceBetween - 4.dp).roundToPx())
                    }.layout { measurable, constraints ->
                        val paddingPx = spaceBelow.roundToPx()
